...
#define ESP32_GPIO_23 23 // Interrupt button used to add new wifi in case of any change
...
#define INT_BUTTON ESP32_GPIO_23  // Interrupt button used to add new wifi in case of any change
